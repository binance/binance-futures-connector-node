...
describe('#removeEmptyValue', () => {
  ...
  it.each([
    ...
    'should remove invalid value %s and return an empty object',
    (invalidValue) => {
...
describe('#buildQueryString', () => {
  ...
  `('should return a query string $output', ({ inputObj, output }) =>
    expect(buildQueryString(inputObj)).toStrictEqual(output)
  )

  it.each([[false], [undefined], [''], [null], [NaN]])(
    'should return an empty string when receives a falsy value',
    (input) => {
...
describe('#flowRight', () => {
  it('should create a new composite function', () => {
    ...
    expect(flowRight(squareFunction, incrementFunction)(2)).toStrictEqual(
      expectedFunction(2)
    )
  })
  ...
  it('should be the same when there is only 1 input function', () => {
    ...
    expect(flowRight(incrementFunction)(2)).toStrictEqual(expectedFunction(2))
  })
  ...
  it('should create a new composite function given 3 inputs', () => {
    ...
    expect(
      flowRight(subtractionFunction, squareFunction, incrementFunction)(2)
    ).toStrictEqual(expectedFunction(2))
  })

  it('should create a new composite class', () => {
    const ClassA = (superclass) =>
